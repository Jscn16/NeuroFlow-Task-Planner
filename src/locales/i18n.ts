...
export const translations: Record<Language, Translations> = {
    en: {
        ...
        settings: {
            ...
            calendarDesc: 'Adds calendar scheduling and time-based planning.',
    ...
    de: {
        ...
        settings: {
            ...
            features: 'Funktionen',
            enableCalendar: 'Kalender aktivieren',
            calendarDesc: 'Fügt Kalenderplanung und zeitbasierte Planung hinzu.',
